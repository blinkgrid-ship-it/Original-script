...
export default function AuthModal({ onClose, onSuccess }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md bg-ink border border-parchment/10 rounded-t-2xl sm:rounded-2xl p-8 pb-12 sm:pb-8">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-parchment/30 hover:text-parchment text-xl"
        >
          ✕
        </button>
